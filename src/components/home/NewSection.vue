<template>
  <section id="new">
    <div class="mb-6">
      <h2 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Nauji vaizdo įrašai</h2>
      <p class="text-sm text-muted dark:text-gray-400">Naujausi vaizdo įrašai iš lietuviškų YouTube kanalų</p>
    </div>
