    ...
    <div class="p-4 flex flex-col flex-1">
      ...
      <div class="flex flex-col gap-2 text-sm text-muted dark:text-gray-400 mt-auto">
        ...
        <div class="flex items-center justify-between">
          ...
          <div v-if="video.trend && video.trend.gain > 0" class="flex items-center gap-1 px-2 py-1 bg-green-50 dark:bg-green-900/20 rounded-full border border-green-200 dark:border-green-800">
